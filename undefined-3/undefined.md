...
좀비 네트워크는 토큰 가격의 급격한 변동성을 방어할 수 있도록 디플레이셔너리 토 기반의 다양한 정책이 반영되어 설계되었습니다. 좀비 네트워크의 토크노믹스 구조상 BLOOD 토큰의 유통량은 자연스럽게 점점 줄어드는 구조로 작동되어, 네트워크가 활성화 될수록 토큰 가격의 상승 모멘텀이 증가합니다[(\[참고\] 좀비 네트워크 특징 > 디플레이셔너리 토큰).](../undefined-1/undefined.md)
