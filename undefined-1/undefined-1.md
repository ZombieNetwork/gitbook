...
추천인 보상을 위해 보유하고 있어야 하는 Bloody NFT는 DeFi 기술과 와 NFT 기술을 연계하여 개발하으며, 좀비에게 필요한 다양한 도구를 상징화한 이미지로 여러 종류의 NFT로 구성되어 있습니다. 사용자는  원하는 종류의 Bloody NFT를 구매하시면 되고 Bloody NFT 간의 기능 차이는 없습니다. 종류에 상관없이 하위라인 단계별로 필요한 Bloody NFT 수량만 보유하시면 됩니다.
