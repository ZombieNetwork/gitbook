...
**둘째 조건:** 하위라인 단계별 보상 조건에 부합하는 Bloody NFT를 보유하고 있어야 합니다. 하위라인 단계별 보상을 받기 위해 필요한 Bloody NFT 수량은 다음과 같습니다. 예를 들어 3번째 하위라인의 투자활동 (예치 및 재예치)에 따른 보상금을 수령하기 위해서는 7개의 Bloody NFT를 보유하고 있어야 합니다. 추천인 보상금 수령을 위한 Bloody NFT는 사이트내 NFT 스토어에서 구매하실 수 있습니다.
...
\
**\* 업데이트 사항:** NFT 판매 가격과 공급량에 대한 부분을 커뮤니티와 의논하여 조정하는 부분에서 NFT의 공급량이 증가되었습니다.\
이에 따라 증가된 공급량으로 인해 발생할 수 있는 추천인 보상 인플레이션 현상을 예방하기 위해 필요한 Bloody NFT 수량을 상향 조정하였습니다.
