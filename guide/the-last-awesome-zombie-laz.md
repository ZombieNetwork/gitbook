...
참여하기 위한 최소 자금(Available Rewards에 표시된 금)은 10 BLD 이상입니다. 전체 참여 금액 중 1 BLD가 지출되며 이 중 80%인 0.8 BLD 가 잭팟풀로 투입되며 남은 0.2 BLD 중  절반인 0.1 BLD는 세금풀로, 나머지 0.1 BLD는  개발 및 마케팅 자금으로 할당됩니다. 남은 9 BLD 는 좀비 네트워크 스테이킹에 자동으로 자금이 들어가게 되어 투자자는 장기투자로 추가 복리 수익을 얻을 수 있습니다.
